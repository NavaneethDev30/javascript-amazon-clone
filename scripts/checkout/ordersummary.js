...
function deliveryOptionsHTML(matchingProduct, cartitem) {
    ...
    deliveryOptions.forEach((deliveryOptions) => {
        ...
        const priceString = deliveryOptions.priceCents === 0 ? 'FREE'
        ...
        html += `
         <div class="delivery-option delivery-option-js" data-product-id=${matchingProduct.id}
...
document.querySelectorAll('.delivery-option-js')
.forEach((element)=>{
